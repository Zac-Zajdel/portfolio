...
This guide aims to illuminate the process of developing a CLI tool that generates files in [Front Matter](https://mdxjs.com/guides/frontmatter/) format,
...
- Outputs the captured data using `console.log()` back to the user.
...
```javascript filename="package.json" copy
  scripts: {
